# YangLeGeYang_web
羊了个羊网页版在线版助手，更新至：`2022/09/22 10:00:00`

## 一些想说的话
目前无法通关，尝试修改难度后手动通关，也不加次数，不知道什么原因，找到原因后会同步更新
本项目旨在为你快速通关羊了个羊，上手需要一定动手能力以及门槛，请勿使用本程序恶意对游戏服务器持续造成压力，一切后果自负！！！`t 参数包含个人信息，任何情况请勿泄漏`

## 如何使用?
点击本页面绿色code按钮===>>>点击download zip 下载代码===>>>下载后解压YangLeGeYang_web-main文件夹===>>>打开YangLeGeYang_web-main文件夹，打开index.html，即可奔放
